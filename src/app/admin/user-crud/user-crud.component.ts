...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule,HttpClientXsrfModule,FormsModule],
...
export class UserCrudComponent implements OnInit{
  ...
  getAllUser(){
    this.adminService.allUser().subscribe(data =>{
      ...
      console.log("all_user_data"+this.all_user_data.value);
    },error =>{
  ...
  addUser(){
    ...
    console.log("addEditUserForm=="+this.addEditUserForm.value);
