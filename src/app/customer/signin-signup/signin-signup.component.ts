...
constructor(private router:Router,private formBuilder:FormBuilder, private loginService:LoginSignupService){
  ...
  // groouping the object which is mentioned on form
  ...
  get rf() {
    ...
    onSubmitSignUp(){
      this.signUpsubmitted =true;
       // Log form control statuses
  console.log('Form invalid:', this.signUpfrom.invalid);
  Object.keys(this.signUpfrom.controls).forEach(controlName => {
    const control = this.signUpfrom.get(controlName);
    console.log(controlName, 'valid:', control?.valid, 'touched:', control?.touched, 'dirty:', control?.dirty);
  });
    ...
    onSubmitSignIn(){
      ...
      .subscribe(data=>{
        ...
        console.log("user_data_length:", this.user_data.length);
